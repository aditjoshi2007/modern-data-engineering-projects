...
################################ INVOKE EXAMPLES #######################################
# python3 glue_cleanup.py --region aws_region --database datalake_landing --prefix sf --crawlers tables_curated_structure
# python3 glue_cleanup.py --region aws_region --database datalake_landing --tables tbl_name
# python3 glue_cleanup.py --region aws_region --crawlers tables_curated_structure
#######################################################################################
